        ...
        <tbody>
          ...
          <tr>
            ...
            <td>
              <ul>
                ...
                <li>
                  most trusted travel companion because of the social profile it
                  provides to users,
                </li>
                <li>
                  Recently added feature to create travel plans where users can
                  invite users and add the content from tripadvisor's explore
                  section to their plan.
                </li>
              </ul>
            </td>
            ...
            <td>
              <ul>
                ...
                <li>
                  Quality and variety of travel content it provides to the users
                  is competition
                </li>
              </ul>
            </td>
            ...
            <td>
              <ul>
                ...
                <li>
                  Primary focus is on the planning features more than the travel
                  content
                </li>
                <li>
                  Only provides travel destinations as standalone places without
                  context to help users make decisions
                </li>
                <li>
                  Allows the user to share the trip with multiple people using a
                  QR code and PIN number
                </li>
                <li>
          ...
          <tr>
            ...
            <td>
              <ul>
                ...
                <li>
                  Popover labels and a sample trip were provided for onboarding,
                  but it still felt non-intuitive,
                </li>
                <li>
            ...
            <td>
              <ul>
                ...
                <li>
                  Reviews on Playstore mention that planning is oversimplified,{" "}
                </li>
                <li>
            ...
            <td>
              <ul>
                ...
                <li>
                  {" "}
                  Helpful to have a better onboarding and instructions design to
                  understand the app's capabilities,
                </li>
                <li>
                  Only app that has a chat feature but difficult to discover it.
                </li>
              </ul>
            </td>
          </tr>
          ...
          <tr>
            ...
            <td>
              <ul>
                <li>
                  ...
                  compare prices, make site bookings, and even create their own
                  travel plans,
                </li>
                <li>
                ...
                <li>linear process is too difficult to remember every time.</li>
              </ul>
            </td>
            ...
            <td>
              <ul>
                <li>
                  Allows users to switch between exploring the commercial trips
                  and exploring travel guides as articles.
                </li>
                <li>
                ...
                <li>
                  Categorization of the guide articles into user-friendly labels
                  helps users to make quick decisions based on their preferences
                </li>
              </ul>
            </td>
            ...
            <td>
              <ul>
                <li>
                  ...
                  considering 3 of them don't serve the primary function of trip
                  planning.
                </li>
                <li>
                ...
                <li>
                  Adding a new place is a pain point where users have to search
                ...
                <li>
                  When exploring a particular city, the information is laid out
          ...
          <tr>
            ...
            <td>
              <ul>
                ...
                <li>
                  Layout is clean and minimalist although the focus is too much
                  on the text than images,
                </li>
                <li>
            ...
            <td>
              <ul>
                ...
                <li>
                  The elements are huge & easily clickable, we feel that some of
                  them are unnecessarily oversized,
                </li>
                <li>White text overlaid on images causes legibility issues</li>
              </ul>
            </td>
            ...
            <td>
              <ul>
                ...
                <li>
                  Use of high quality travel images and very high proportion of
                  layout given to images,
                </li>
                <li>
                  Clear hierarchy in typography but the small label text has
                  accessibility issues,
                </li>
                <li>Iconography is a bit inconsistent with multiple styles.</li>
              </ul>
            </td>
          </tr>
          <tr>
            ...
            <td>
              <ul>
                <li>
                  Closest to our proposed product and has several good reviews,
                </li>
                <li>
            ...
            <td>
              <ul>
                ...
                <li>
                  Instead of a linear way, our app will offer multiple paths to
                  add a places,
                </li>
            ...
            <td>
              <ul>
                <li>
                  Culture Trip focuses a lot on selling their trip packages but
                  tries to provide travel guide content.
                </li>
                <li>
                ...
                <li>
                  We will take extra care of accessibility wherever two or more
                  media elements overlap,
                </li>
                <li>
            ...
            <td>
              <ul>
                ...
                <li>
                  Useful to store the documents, photos, bookings, notes, lists,
                  and expenses but fails at providing the primary functions,
                </li>
                <li>
